                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 laorenPhotoDiv">
                                        <label>老人照片</label>
                                        <img id="laorenPhotoImg" src="" width="100" height="100">
                                        <input name="file" type="file" id="laorenPhotoupload"
                                               class="form-control-file">
                                        <input name="laorenPhoto" id="laorenPhoto-input" type="hidden">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 laorenAddressDiv">
                                        <label>老人住址</label>
                                        <input style="width: 450px" id="laorenAddress" name="laorenAddress" class="form-control"
                                               placeholder="老人住址">
                                    </div>
                                    <div class="form-group col-md-6 laorenIdNumberDiv">
                                        <label>身份证号</label>
                                        <input style="width: 450px" id="laorenIdNumber" name="laorenIdNumber" class="form-control"
                                               onchange="laorenIdNumberChickValue(this)"  placeholder="身份证号">
                                    </div>
                                    <div class="form-group col-md-6 qinshuxingmingDiv">
                                        <label>亲属姓名</label>
                                        <input style="width: 450px" id="qinshuxingming" name="qinshuxingming" class="form-control"
                                               placeholder="亲属姓名">
                                    </div>
                                    <div class="form-group col-md-6 qinshuxingmingPhoneDiv">
                                        <label>亲属联系方式</label>
                                        <input style="width: 450px" id="qinshuxingmingPhone" name="qinshuxingmingPhone" class="form-control"
                                               onchange="qinshuxingmingPhoneChickValue(this)"  placeholder="亲属联系方式">
                                    </div>
                                    <div class="form-group col-md-6 yiliaokahaoDiv">
                                        <label>医疗卡号</label>
...
<script>
    ...
    function upload() {
        ...
        <!-- 当前表的文件上传 -->
        $('#laorenPhotoupload').fileupload({
            url: baseUrl + 'file/upload',
            headers: {token: window.sessionStorage.getItem("token")},
            dataType: 'json',
            done: function (e, data) {
                var photoUrl= baseUrl + 'file/download?fileName=' + data.result.file;
                document.getElementById('laorenPhotoImg').setAttribute('src',photoUrl);
                document.getElementById('laorenPhoto-input').setAttribute('value',photoUrl);
            }
        });
    ...
    //数字检查
        ...
        function qinshuxingmingPhoneChickValue(e){
            var this_val = e.value || 0;
            var reg=/^(13[0-9]|14[01456879]|15[0-35-9]|16[2567]|17[0-8]|18[0-9]|19[0-35-9])\d{8}$/;
            if(!reg.test(this_val)){
                e.value = "";
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                username: "required",
                password: "required",
                laorenUuidNumber: "required",
                laorenName: "required",
                laorenPhone: "required",
                laorenPhoto: "required",
                sexTypes: "required",
                nianling: "required",
                laorenAddress: "required",
                laorenIdNumber: "required",
                qinshuxingming: "required",
                qinshuxingmingPhone: "required",
                yiliaokahao: "required",
            },
            messages: {
                username: "账户不能为空",
                password: "密码不能为空",
                laorenUuidNumber: "老人编号不能为空",
                laorenName: "老人姓名不能为空",
                laorenPhone: "老人手机号不能为空",
                laorenPhoto: "老人照片不能为空",
                sexTypes: "性别不能为空",
                nianling: "年龄不能为空",
                laorenAddress: "老人住址不能为空",
                laorenIdNumber: "身份证号不能为空",
                qinshuxingming: "亲属姓名不能为空",
                qinshuxingmingPhone: "亲属联系方式不能为空",
                yiliaokahao: "医疗卡号不能为空",
            }
        }).form();
    }
    ...
    function getDetails() {
        ...
        if (addlaoren != null && addlaoren != "" && addlaoren != "null") {
            //注册表单验证
            $(validform());
            $("#laorenUuidNumber").val(new Date().getTime()+Math.ceil(Math.random()*10));//设置唯一号
