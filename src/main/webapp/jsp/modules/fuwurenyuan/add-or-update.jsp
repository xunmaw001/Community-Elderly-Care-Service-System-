    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑服务人员</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">服务人员管理</li>
                        <li class="breadcrumb-item active">编辑服务人员</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">服务人员信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 fuwurenyuanUuidNumberDiv">
                                        <label>服务人员编号</label>
                                        <input style="width: 450px" id="fuwurenyuanUuidNumber" name="fuwurenyuanUuidNumber" class="form-control"
                                               placeholder="服务人员编号">
                                    </div>
                                    <div class="form-group col-md-6 fuwurenyuanNameDiv">
                                        <label>服务人员姓名</label>
                                        <input style="width: 450px" id="fuwurenyuanName" name="fuwurenyuanName" class="form-control"
                                               placeholder="服务人员姓名">
                                    </div>
                                    <div class="form-group col-md-6 fuwurenyuanPhoneDiv">
                                        <label>服务人员手机号</label>
                                        <input style="width: 450px" id="fuwurenyuanPhone" name="fuwurenyuanPhone" class="form-control"
                                               onchange="fuwurenyuanPhoneChickValue(this)"  placeholder="服务人员手机号">
                                    </div>
                                    <div class="form-group col-md-6 fuwurenyuanPhotoDiv">
                                        <label>服务人员头像</label>
                                        <img id="fuwurenyuanPhotoImg" src="" width="100" height="100">
                                        <input name="file" type="file" id="fuwurenyuanPhotoupload"
                                               class="form-control-file">
                                        <input name="fuwurenyuanPhoto" id="fuwurenyuanPhoto-input" type="hidden">
                                    </div>
...
<script>
    ...
    function upload() {
        ...
        <!-- 当前表的文件上传 -->
        $('#fuwurenyuanPhotoupload').fileupload({
            url: baseUrl + 'file/upload',
            headers: {token: window.sessionStorage.getItem("token")},
            dataType: 'json',
            done: function (e, data) {
                var photoUrl= baseUrl + 'file/download?fileName=' + data.result.file;
                document.getElementById('fuwurenyuanPhotoImg').setAttribute('src',photoUrl);
                document.getElementById('fuwurenyuanPhoto-input').setAttribute('value',photoUrl);
            }
        });
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("fuwurenyuan/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addfuwurenyuan');
    ...
    //数字检查
        <!-- 当前表的数字检查 -->
        function fuwurenyuanPhoneChickValue(e){
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                username: "required",
                password: "required",
                fuwurenyuanUuidNumber: "required",
                fuwurenyuanName: "required",
                fuwurenyuanPhone: "required",
                fuwurenyuanPhoto: "required",
                sexTypes: "required",
                fuwurenyuanEmail: "required",
            },
            messages: {
                username: "账户不能为空",
                password: "密码不能为空",
                fuwurenyuanUuidNumber: "服务人员编号不能为空",
                fuwurenyuanName: "服务人员姓名不能为空",
                fuwurenyuanPhone: "服务人员手机号不能为空",
                fuwurenyuanPhoto: "服务人员头像不能为空",
                sexTypes: "性别不能为空",
                fuwurenyuanEmail: "服务人员电子邮箱不能为空",
            }
        }).form();
    }
    ...
    // 获取当前详情
    function getDetails() {
        var addfuwurenyuan = window.sessionStorage.getItem("addfuwurenyuan");
        if (addfuwurenyuan != null && addfuwurenyuan != "" && addfuwurenyuan != "null") {
            //注册表单验证
            $(validform());
            $("#fuwurenyuanUuidNumber").val(new Date().getTime()+Math.ceil(Math.random()*10));//设置唯一号
            ...
            window.sessionStorage.removeItem('updateId');
            http("fuwurenyuan/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
