            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">医疗保险登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="laorenId" name="laorenId" v-model="ruleForm.laorenId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="yibaokahao" name="yibaokahao" class="form-control"
                                               v-model="ruleForm.yibaokahao" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="yiliaobaoxianNumber" name="yiliaobaoxianNumber" class="form-control"
                                               v-model="ruleForm.yiliaobaoxianNumber" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="diqu" name="diqu" class="form-control"
                                               v-model="ruleForm.diqu" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="yiyuan" name="yiyuan" class="form-control"
                                               v-model="ruleForm.yiyuan" readonly>
                                    </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "yiliaobaoxian/info/" + id,
