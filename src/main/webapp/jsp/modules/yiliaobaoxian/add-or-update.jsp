    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑医疗保险</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">医疗保险管理</li>
                        <li class="breadcrumb-item active">编辑医疗保险</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">医疗保险信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="laorenId" name="laorenId" type="hidden">
                                    <div class="form-group col-md-6 yibaokahaoDiv">
                                        <label>医保卡号</label>
                                        <input style="width: 450px" id="yibaokahao" name="yibaokahao" class="form-control"
                                               placeholder="医保卡号">
                                    </div>
                                    <div class="form-group col-md-6 yiliaobaoxianNumberDiv">
                                        <label>账户余额</label>
                                        <input style="width: 450px" id="yiliaobaoxianNumber" name="yiliaobaoxianNumber" class="form-control"
                                               onchange="yiliaobaoxianNumberChickValue(this)" placeholder="账户余额">
                                    </div>
                                    <div class="form-group col-md-6 diquDiv">
                                        <label>可报销地区</label>
                                        <input style="width: 450px" id="diqu" name="diqu" class="form-control"
                                               placeholder="可报销地区">
                                    </div>
                                    <div class="form-group col-md-6 yiyuanDiv">
                                        <label>主要合作医院</label>
                                        <input style="width: 450px" id="yiyuan" name="yiyuan" class="form-control"
                                               placeholder="主要合作医院">
                                    </div>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("yiliaobaoxian/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addyiliaobaoxian');
    ...
    //数字检查
        <!-- 当前表的数字检查 -->
        function yiliaobaoxianNumberChickValue(e){
    ...
    // 获取当前详情
    function getDetails() {
        var addyiliaobaoxian = window.sessionStorage.getItem("addyiliaobaoxian");
        if (addyiliaobaoxian != null && addyiliaobaoxian != "" && addyiliaobaoxian != "null") {
            //注册表单验证
            $(validform());
            ...
            window.sessionStorage.removeItem('updateId');
            http("yiliaobaoxian/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#yibaokahao").val(ruleForm.yibaokahao);
        $("#yiliaobaoxianNumber").val(ruleForm.yiliaobaoxianNumber);
        $("#diqu").val(ruleForm.diqu);
