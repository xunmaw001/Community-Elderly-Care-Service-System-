...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">医疗保险管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">医疗保险列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">医疗保险列表</h3>
    ...
    <script>
        ...
        function getDataList() {
            http("yiliaobaoxian/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                yiliaobaoxianDelete: 1,
                //本表的
            //级联表的
...
/*
            ...
            //医保卡号
            var yibaokahaoCell = document.createElement('td');
            yibaokahaoCell.innerHTML = item.yibaokahao;
            row.appendChild(yibaokahaoCell);


            //账户余额
            var yiliaobaoxianNumberCell = document.createElement('td');
            yiliaobaoxianNumberCell.innerHTML = item.yiliaobaoxianNumber;
            row.appendChild(yiliaobaoxianNumberCell);


            //可报销地区
            var diquCell = document.createElement('td');
            diquCell.innerHTML = item.diqu;
            row.appendChild(diquCell);


            //主要合作医院
            var yiyuanCell = document.createElement('td');
            yiyuanCell.innerHTML = item.yiyuan;
            row.appendChild(yiyuanCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("yiliaobaoxian/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addyiliaobaoxian", "addyiliaobaoxian");
            window.location.href = "add-or-update.jsp"
        }
