...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">身体状况管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">身体状况列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">身体状况列表</h3>
    ...
    <script>
        ...
        function getDataList() {
            http("shentizhuangkuang/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                shentizhuangkuangDelete: 1,
                //本表的
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //疾病状况
            var jibingTextCell = document.createElement('td');
            jibingTextCell.innerHTML = item.jibingText;
            row.appendChild(jibingTextCell);


            //患病时长
            var huanbingshichangCell = document.createElement('td');
            huanbingshichangCell.innerHTML = item.huanbingshichang;
            row.appendChild(huanbingshichangCell);


            //治疗医院
            var zhiliaoyiyuanCell = document.createElement('td');
            zhiliaoyiyuanCell.innerHTML = item.zhiliaoyiyuan;
            row.appendChild(zhiliaoyiyuanCell);


            //治疗时长
            var zhiliaoshichangCell = document.createElement('td');
            zhiliaoshichangCell.innerHTML = item.zhiliaoshichang;
            row.appendChild(zhiliaoshichangCell);


            //复诊周期
            var fuzhenzhouqiCell = document.createElement('td');
            fuzhenzhouqiCell.innerHTML = item.fuzhenzhouqi;
            row.appendChild(fuzhenzhouqiCell);


            //疾病注意事项
            var jibingzhuyishixiangTextCell = document.createElement('td');
            jibingzhuyishixiangTextCell.innerHTML = item.jibingzhuyishixiangText;
            row.appendChild(jibingzhuyishixiangTextCell);


            //用药情况
            var yongyaoqingkuangTextCell = document.createElement('td');
            yongyaoqingkuangTextCell.innerHTML = item.yongyaoqingkuangText;
            row.appendChild(yongyaoqingkuangTextCell);


            //用药事项
            var yongyaoshixiangTextCell = document.createElement('td');
            yongyaoshixiangTextCell.innerHTML = item.yongyaoshixiangText;
            row.appendChild(yongyaoshixiangTextCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("shentizhuangkuang/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addshentizhuangkuang", "addshentizhuangkuang");
            window.location.href = "add-or-update.jsp"
        }
